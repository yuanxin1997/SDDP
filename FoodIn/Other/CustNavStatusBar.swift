...
protocol CustomNavStatusBarProtocol {
    func setupCustomNavStatusBar(setting: Set<navSettings>)
}

extension UIViewController: CustomNavStatusBarProtocol {
    public func setupCustomNavStatusBar(setting: Set<navSettings>) {
        ...
        case [.blackStatusBar, .greyNavTitle]:
            ...
            navigationController?.navigationBar.titleTextAttributes = [ NSAttributedStringKey.foregroundColor: Colors.darkgrey, NSAttributedStringKey.font: UIFont(name: "Arial Rounded MT Bold", size: 20)!]
        case [.whiteStatusBar, .whiteNavTitle, .whiteNavTint]:
            UIApplication.shared.statusBarStyle = .lightContent
            navigationController?.navigationBar.tintColor = Colors.white
            navigationController?.navigationBar.titleTextAttributes = [ NSAttributedStringKey.foregroundColor: Colors.white, NSAttributedStringKey.font: UIFont(name: "Arial Rounded MT Bold", size: 20)!]
